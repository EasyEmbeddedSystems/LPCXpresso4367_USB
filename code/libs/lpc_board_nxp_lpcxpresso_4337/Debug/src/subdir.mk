...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M4 -I"/home/main/Nas/will/06_WK/git/LPCXpresso4367_USB/code/libs/lpc_board_nxp_lpcxpresso_4337/inc" -I"/home/main/Nas/will/06_WK/git/LPCXpresso4367_USB/code/libs/lpc_chip_43xx/inc" -I"/home/main/Nas/will/06_WK/git/LPCXpresso4367_USB/code/libs/lpc_chip_43xx/inc/config_43xx" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fsingle-precision-constant -fmerge-constants -fmacro-prefix-map="../$(@D)/"=. -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
